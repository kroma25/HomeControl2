...
class APChartMarkerLine3  {
    var chart:APChartView3
    var x:APMarker3?
    var y:APMarker3?
    var title:String = "line"
    var lineColor:UIColor = UIColor.black
    var lineWidth:CGFloat = 1.0
    init(chartView:APChartView3, title:String, x:CGFloat, lineColor:UIColor? =  UIColor.red) {
        self.chart = chartView
        self.title = title
        self.lineColor = lineColor!
        self.x = APMarker3(value: x, point: x, pointEnd:x, label: title)
    }
    init(chartView:APChartView3, title:String, y:CGFloat, lineColor:UIColor? =  UIColor.red) {
        self.chart = chartView
        self.title = title
        self.lineColor = lineColor!
        self.y = APMarker3(value: y, point: y, pointEnd:y, label: title)
