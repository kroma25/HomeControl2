...
class APChartLine3  {
    ...
    init(chartView:APChartView3, title:String, points:[APChartPoint3]) {
        self.chart = chartView
        self.title = title
        self.dots = points
    }
    init(chartView:APChartView3, title:String, lineWidth:CGFloat, lineColor:UIColor) {
        self.chart = chartView
        self.title = title
