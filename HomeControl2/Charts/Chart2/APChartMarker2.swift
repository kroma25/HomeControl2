...
class APChartMarkerLine2  {
    var chart:APChartView2
    var x:APMarker2?
    var y:APMarker2?
    var title:String = "line"
    var lineColor:UIColor = UIColor.black
    var lineWidth:CGFloat = 1.0
    init(chartView:APChartView2, title:String, x:CGFloat, lineColor:UIColor? =  UIColor.red) {
        self.chart = chartView
        self.title = title
        self.lineColor = lineColor!
        self.x = APMarker2(value: x, point: x, pointEnd:x, label: title)
    }
    init(chartView:APChartView2, title:String, y:CGFloat, lineColor:UIColor? =  UIColor.red) {
        self.chart = chartView
        self.title = title
        self.lineColor = lineColor!
        self.y = APMarker2(value: y, point: y, pointEnd:y, label: title)
