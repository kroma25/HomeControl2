...
class APChartLine2  {
    ...
    init(chartView:APChartView2, title:String, points:[APChartPoint2]) {
        self.chart = chartView
        self.title = title
        self.dots = points
    }
    init(chartView:APChartView2, title:String, lineWidth:CGFloat, lineColor:UIColor) {
        self.chart = chartView
        self.title = title
