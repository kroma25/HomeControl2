...
class APChartLine1  {
    ...
    init(chartView:APChartView1, title:String, points:[APChartPoint1]) {
        self.chart = chartView
        self.title = title
        self.dots = points
    }
    init(chartView:APChartView1, title:String, lineWidth:CGFloat, lineColor:UIColor) {
        self.chart = chartView
        self.title = title
